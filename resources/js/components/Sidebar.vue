        ...
        <div class="card p-0 m-0">
            <div class="card-body p-3">
                <div class="d-flex align-items-center small mb-0">
                    ...
                    <strong>Persempit Pencarian Pekerjaan Anda</strong>
                </div>
                <a
                    href="#"
        ...
        <div id="accordion">
            <div class="card border-top-0">
                <div class="card-body p-3" id="jobCategories">
                    <div class="pb-0">
                        <div class="card-title mb-1">Kategori Pekerjaan</div>
                        <div class="card-body p-0">
                            <div class="form-group">
                                <select
                                    name="job_category"
                                    class="form-control"
                                    placeholder="Saring berdasarkan Kategori Pekerjaan"
                    ...
                    <hr class="my-3" />
                    <div class="pb-0">
                        <div class="card-title mb-1">Tingkat Pekerjaan</div>
                        <div class="card-body p-0">
                            <div class="form-group">
                                <select
                                    name="job_category"
                    ...
                    <hr class="my-3" />
                    <div class="pb-0">
                        <div class="card-title mb-1">Pendidikan</div>
                        <div class="card-body p-0">
                            <div class="form-group">
                                <select
                                    name="job_category"
                    ...
                    <hr class="my-3" />
                    <div class="pb-0">
                        <div class="card-title mb-1">Tipe Pekerjaan</div>
                        <div class="card-body p-0">
                            <div class="form-group">
                                <select
                                    name="job_category"
