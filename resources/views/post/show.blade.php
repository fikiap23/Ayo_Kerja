                    ...
                    <div class="job-listing border">
                        <div class="company-info">
                            <div class="company-banner">
                                ...
                                <div class="company-media">
                                    ...
                                    <div>
                                        <a href="{{ route('account.employer', ['employer' => $company]) }}"
                        ...
                        <div class="job-info">
                            <div class="job-hdr p-3">
                                ...
                                <div class="">
                                    <p class="job-views">
                                        <span class="text-success">Dilihat: {{ $post->views }} </span> |
                                        <span class="text-danger">Lamar Sebelum: {{ date('d', $post->remainingDays()) }}
                                            hari</span>
                                    </p>
                                </div>
                            </div>
                            <div class="job-bdy p-3 my-3">
                                <div class="job-level-description">
                                    <p class="font-weight-bold">Deskripsi Pekerjaan Level Dasar</p>
                                    <table class="table table-hover">
                                        <tbody>
                                            <tr>
                                                <td width="33%">Kategori Pekerjaan</td>
                                                <td width="3%">:</td>
                                                <td width="64%"><a
                                                        href="/jobs">{{ $company->getCategory->category_name }}</a></td>
                                            </tr>
                                            <tr>
                                                <td width="33%">Level Pekerjaan</td>
                                                <td width="3%">:</td>
                                                <td width="64%">{{ $post->job_level }}</td>
                                            </tr>
                                            <tr>
                                                <td width="33%">Jumlah Posisi yang Tersedia</td>
                                                <td width="3%">:</td>
                                                <td width="64%">[ <strong>{{ $post->vacancy_count }}</strong> ]</td>
                                            </tr>
                                            <tr>
                                                <td width="33%">Tipe Pekerjaan</td>
                                                <td width="3%">:</td>
                                                <td width="64%">{{ $post->employment_type }}</td>
                                            </tr>
                                            <tr>
                                                <td width="33%">Gaji yang Ditawarkan (Per Bulan)</td>
                                                <td width="3%">:</td>
                                                <td width="64%">{{ $post->salary }}</td>
                                            </tr>
                                            <tr>
                                                <td width="33%">Lamar Sebelum (Batas Waktu)</td>
                                                <td width="3%">:</td>
                                                <td width="64%" class="text-danger">
                                                    {{ date('l, jS \of F Y', $post->deadlineTimestamp()) }},
                                                    ({{ date('d', $post->remainingDays()) }} hari lagi)</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                <div class="job-level-description">
                                    <p class="font-weight-bold">Spesifikasi Pekerjaan</p>
                                    <table class="table table-hover">
                                        <tbody>
                                            <tr>
                                                <td width="33%">Tingkat Pendidikan</td>
                                                <td width="3%">:</td>
                                                <td width="64%"><a href="/jobs"> {{ $post->education_level }}</a></td>
                                            </tr>
                                            <tr>
                                                <td width="33%">Pengalaman yang Dibutuhkan</td>
                                                <td width="3%">:</td>
                                                <td width="64%">{{ $post->experience }}</td>
                                            </tr>
                                            <tr>
                                                <td width="33%">Keterampilan Profesional yang Dibutuhkan</td>
                                                <td width="3%">:</td>
                                                <td width="64%">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="{{ route('account.applyJob', ['post_id' => $post]) }}"
                                            class="btn primary-btn">Lamar Sekarang</a>
                                        <a href="{{ route('savedJob.store', ['id' => $post]) }}"
                                            class="btn primary-outline-btn"><i class="fas fa-star"></i> Simpan Pekerjaan</a>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="btn-group w-100">
                                <a href="{{ route('account.applyJob', ['post_id' => $post->id]) }}"
                                    class="btn primary-outline-btn float-left">Lamar Sekarang</a>
                                <a href="{{ route('savedJob.store', ['id' => $post->id]) }}" class="btn primary-btn"><i
                                        class="fas fa-star"></i> Simpan Pekerjaan</a>
                            </div>
                        </div>
                    </div>
                    <div class="card ">
                                        ...
                                        <div class="job-item border-bottom row">
                                            ...
                                            <div class="job-desc col-8">
                                                <a href="{{ route('post.show', ['job' => $post]) }}"
                                                    ...
                                                    <p class="font-weight-normal small text-danger">Batas Waktu:
                                                        {{ date('d', $job->remainingDays()) }} hari</p>
                                                </a>
                                            </div>
                                        </div>
                                    @else
                                        <div class="card">
                                            <div class="card-header">
                                                <p>Tidak ada pekerjaan serupa</p>
                                            </div>
                                        </div>
                                    @endif
                                @endforeach
