                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="px-4">
                            <div class="rounded-text">
                                <p>
                                    Temukan pekerjaan, lowongan, karir online.
                                </p>
                            </div>
                            <div class="home-search-bar">
                                <input type="text" name="q" placeholder="Cari Pekerjaan Berdasarkan Judul"
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="py-5 px-5 text-center">
                            <div class="text-light">
                                <h4>Mimpi tidak menjadi kenyataan melalui sihir, butuh keringat, determinasi, dan kerja
                                    keras.
                                </h4>
                            </div>
                        </div>
        ...
        <div class="container-fluid px-0">
            <div class="row ">
                <div class="col-sm-12 col-md-7 ml-auto">
                    <div class="card">
                        <div class="card-header">
                            <p class="card-title font-weight-bold"><i class="fas fa-briefcase"></i> Pekerjaan Teratas</p>
                        </div>
                        <div class="card-body">
                            <div class="top-jobs">
                                <div class="row">
                        ...
                        <a class="btn secondary-btn" href="{{ route('job.index') }}">Tampilkan semua pekerjaan</a>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-3 mr-auto">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <p class="font-weight-bold"><i class="fas fa-building"></i> Pemberi Kerja Teratas</p>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card mb-4 job-by-category">
                        <div class="card-header">
                            <p class="font-weight-bold"><i class="fab fa-typo3"></i> Pekerjaan Berdasarkan Kategori</p>
                        </div>
                        <div class="card-body">
                            <div class="jobs-category mb-3 mt-0">
                                ...
                                @endforeach
                                <a class="p-1 text-info" href="{{ route('job.index') }}">Lainnya..</a>
                            </div>
                        </div>
                    </div>
                </div>
