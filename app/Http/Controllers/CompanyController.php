...
class CompanyController extends Controller
{
    ...
    public function create()
    {
        if (auth()->user()->company) {
            Alert::toast('kamu sudah memiliki perusahaan!', 'info');
            return $this->edit();
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($this->companySave($company, $request)) {
            Alert::toast('Perushaan dibuat! Sekarang kamu bisa menambah pekerjaan.', 'success');
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($this->companyUpdate($company, $request)) {
            Alert::toast('Perushaan dibuat!', 'success');
            return redirect()->route('account.authorSection');
        }
